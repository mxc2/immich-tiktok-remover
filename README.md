...
|               Docker Image Description               | x86_64 CPU  |     ARM CPU     |
| :--------------------------------------------------- | :---------: | --------------: |
| Includes Machine Learning to detect TikTok watermark | stable      | stable_arm      |
| Only uses filename to detect TikTok video            | stable-lite | stable-lite_arm |
